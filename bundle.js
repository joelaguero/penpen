...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ArticleCreator = __webpack_require__(163);

	var _ArticleCreator2 = _interopRequireDefault(_ArticleCreator);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_ArticleCreator2.default, { addArticle: this.addArticle.bind(this) }),
	...
	_reactDom2.default.render(_react2.default.createElement(App, { name: 'Jenny' }), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ArticleListEntry = __webpack_require__(162);

	var _ArticleListEntry2 = _interopRequireDefault(_ArticleListEntry);
	  ...
	  _createClass(ArticleList, [{
	    ...
	    value: function render() {
	      ...
	      for (var i = 0; i < this.props.articles.length; i++) {
	        ArticleListEntries.push(_react2.default.createElement(_ArticleListEntry2.default, { key: i, article: this.props.articles[i] }));
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ArticleListEntry = function (_React$Component) {
	  _inherits(ArticleListEntry, _React$Component);

	  function ArticleListEntry(props) {
	    _classCallCheck(this, ArticleListEntry);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ArticleListEntry).call(this, props));

	    _this.handleClick = _this.handleClick.bind(_this);
	    return _this;
	  }

	  _createClass(ArticleListEntry, [{
	    key: 'handleClick',
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { onClick: this.handleClick, style: { margin: '10px 0px', 'max-width': '40%', border: '1px solid' } },
	        _react2.default.createElement('img', { style: { 'max-width': '100%' }, src: article.image }),
	        _react2.default.createElement(
	          'div',
	          { style: { 'margin': '10px' } },
	          _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'p',
	            { style: { 'white-space': 'nowrap', 'overflow': 'hidden', 'text-overflow': 'ellipsis', 'text-transform': 'uppercase', 'color': 'gray', 'font-family': 'sans-serif', 'font-size': '11px', 'margin': '0', 'padding': '0' } },
	            article.site_name,
	            ' · ',
	            article.url
	          ),
	...
	exports.default = ArticleListEntry;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ArticleCreator = function (_React$Component) {
	  _inherits(ArticleCreator, _React$Component);

	  function ArticleCreator(props) {
	    _classCallCheck(this, ArticleCreator);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ArticleCreator).call(this, props));

	    _this.handleClick = _this.handleClick.bind(_this);
	    return _this;
	  }

	  _createClass(ArticleCreator, [{
	    key: 'handleClick',
	    value: function handleClick(e) {
	      e.preventDefault();
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', { type: 'url', ref: 'targetUrl', placeholder: 'Enter a URL' }),
	        _react2.default.createElement(
	          'button',
	          { type: 'submit' },
	          'Create Article'
	...
	exports.default = ArticleCreator;
